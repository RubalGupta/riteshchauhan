...
const mediaItems = [
  {
    ...
    platform: 'YouTube',
    icon: Youtube,
    title: 'Live Session: Governance & Innovation',
    description: 'In-depth discussion on transforming public systems through technology and collaborative leadership.',
    thumbnail: 'https://img.youtube.com/vi/CZnBvNrheU4/maxresdefault.jpg',
    url: 'https://www.youtube.com/live/CZnBvNrheU4?si=INNa8vIKbMJJD-ox&t=16759',
